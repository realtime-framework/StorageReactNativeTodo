...
###Import RCTRealtimeCloudStorageIOS to your project
...
* primaryKey -
The primary key (If the primary key type is NSNumber you have to convert it to NSString)
...
* secondaryKey -
The secondary key (If the primary key type is NSNumber you have to convert it to NSString)
